#ifndef HOLBERTON_H
#define HOLBERTON_H
int _putchar(char c); /* print text */
void print_alphabet(void); /* print alphabet */
void print_alphabet_x10(void); /* print alphabet x 10 */
int _islower(int c); /* check lowercases */
int _isalpha(int c); /* check alphabetic characters */
int print_sign(int n); /* print the sing of a number */
